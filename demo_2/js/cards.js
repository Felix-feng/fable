...
function init() {
  ...
  document.getElementById('wall_button').addEventListener("click",function(){
    fadeBox();
  });

  document.getElementById('pile_button').addEventListener("click",function(){
    showBox();
  });

  document.getElementById('house_button').addEventListener("click",function(){
    showBox();
  });

  document.getElementById('cylinder_button').addEventListener("click",function(){
    showBox();
  });
...
function showBox(){
 /// console.log($('.box').hasClass("stop"))
  if($('.box').hasClass("stop")){
    return;
  }
  setTimeout(function(){
    //document.querySelector(".box").style.display = "block";
    $('.box').fadeIn(2000).addClass("stop");
    console.log(123);
  },2300);
}
function fadeBox(){
  setTimeout(function(){
    ...
    $('.box').fadeOut(1500).removeClass("stop");
  },600);
}
